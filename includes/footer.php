    ...
    <div class="container" style="padding-top:4rem; padding-bottom:4rem;">
        <div class="grid-3" style="gap:2rem;">
            <div>
                ...
                <p style="opacity:0.9; line-height:1.6;">No 205, LOT izidihar, Marrakech 40100.<br>Centre médical pluridisciplinaire.</p>
            </div>
            <div>
                <h3 style="color:white; margin-bottom:1.5rem; font-size:1.25rem;">Liens Rapides</h3>
                <ul style="list-style:none; padding:0; margin:0;">
                    <li style="margin-bottom:0.8rem;"><a href="index.php#services" style="color:rgba(255,255,255,0.8); text-decoration:none;">Services</a></li>
                    <li style="margin-bottom:0.8rem;"><a href="privacy-policy.php" style="color:rgba(255,255,255,0.8); text-decoration:none;">Politique de Confidentialité</a></li>
                    <li><a href="terms-of-service.php" style="color:rgba(255,255,255,0.8); text-decoration:none;">Conditions Générales</a></li>
                </ul>
            </div>
            <div>
                <h3 style="color:white; margin-bottom:1.5rem; font-size:1.25rem;">Contact</h3>
                ...
                <div style="display:flex; flex-wrap:wrap; gap:0.5rem; margin-top:1.5rem;">
                    ...
                    <a href="<?php echo $wa_link; ?>" target="_blank" class="btn btn-outline" style="background:#25D366; border-color:#25D366; color:white; padding:0.5rem 1rem; display:inline-flex; align-items:center; gap:0.5rem;" onclick="fbq('track', 'Lead'); gtag('event', 'generate_lead'); return gtag_report_conversion('<?php echo $wa_link; ?>', 'AW-17847107352/jAtNCPzerd4bEJj-lL5C');">
        ...
        <div class="text-center" style="margin-top:3rem; font-size:0.9rem; border-top:1px solid rgba(255,255,255,0.1); padding-top:2rem; opacity:0.7;">
            FARES MEDICAL CENTER ©2026 All rights reserved. <br>
            <span style="font-size:0.8rem;">Centre Médical Pluridisciplinaire</span>
        </div>
    </div>
</footer>
